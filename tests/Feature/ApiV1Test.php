...
class ApiV1Test extends TestCase
{
    ...
    public function test_lead_webhook_ingestion(): void
    {
        ...
        $verifyToken = env('META_VERIFY_TOKEN', 'safarsystem_meta_token_2026');
        $verifyResponse = $this->get('/api/v1/webhooks/leads/meta?hub_mode=subscribe&hub_verify_token=' . $verifyToken . '&hub_challenge=123456');
